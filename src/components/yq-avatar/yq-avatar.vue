<template name="yq-avatar">
	<view>
        ...
        <!-- <view style="color:#ffffff;z-index:99999999;position:absolute;top:0"></view> top:tp,-->
        
		<view class="oper-wrapper" :style="{display: sD,zIndex:99999999}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<!-- <view @click="fSelect" hover-class="hover" :style="{width: bW}"><text>重选</text></view> -->
					<view @click="fClose" hover-class="hover" :style="{width: bW,color:'#AAAAAA'}"><text>取消</text></view>
					...
					<view @click="fUpload" hover-class="hover" :style="{width: bW,color:'#FFFFFF'}"><text>完成</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload" hover-class="hover" :style="{width: bW}"><text>完成</text></view>
				</view>
			</view>
		</view>
	</view>
