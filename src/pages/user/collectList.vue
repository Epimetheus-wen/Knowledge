			...
			<view class="classifyList_center">
				<view class="classifyList_center_top">
					...
					<view class="right">
						...
						<view v-if="type==1" @tap="upPopup" :style="'top: calc('+((staHeight*2)+148)+'rpx);'" :class="popup1.shade?'shade_popup show_popup':'shade_popup'">
                        ...
                        <view @tap="upPopup1" :style="'top: calc('+((staHeight*2)+148)+'rpx);'" :class="popup2.shade?'shade_popup show_popup':'shade_popup'">
							<view class="popup_content">
								<view 
...
<script>
	...
	export default {
		...
		onHide() {},
		onReady() {
            this.getCateRepositoryList(this.popup2.list[this.popup2.n].id,this.type,this.popup1.list[this.popup1.n].id,this.page)
                .then((res) => {
                    console.log(res)
                    this.list=res
		...
		methods: {
            ...
            getCateRepositoryList(sort,type,ftype,page){
                return new Promise((resolve, reject) => {
                    ...
                    this.$post("/apiIndex.html?f=collectList",data)
                        .then((res) => {
